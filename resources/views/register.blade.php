    ...
    <div class="row">
        ...
        <div class="col-5" id="right-col">
            ...
            <form action="" class="py-5 px-4" method="POST">
                <input type="text" class="form-control mb-4" placeholder="Email address" name="email">
                ...
                <button type="submit" class="btn form-control mt-3" id="btn-login" name="register">Register your account</button>
